...
#define LONG_MIN (-LONG_MAX-1)
    ...
    // Sami: when compiling on amd64 the checking below fails and causes the #error. 
    // not sure what's the real culprit and where the LONG_BIT definition comes from
    //#ifndef LONG_BIT
